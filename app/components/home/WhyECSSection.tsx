  ...
  return (
    <section className="relative py-28 pb-36 bg-bg overflow-hidden" ref={ref}>
      ...
      <div className="absolute bottom-0 left-1/4 w-96 h-48 pointer-events-none opacity-20"
           style={{ background: "radial-gradient(circle, rgba(239,35,60,0.15) 0%, transparent 70%)", filter: "blur(50px)" }} />
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-14 items-center">
          ...
          >
            ...
            <Link
              href="/about"
              className="group inline-flex items-center gap-2 border border-accent/40 text-accent font-semibold px-6 py-3 rounded-xl hover:bg-accent hover:text-white transition-all duration-300"
            >
              Know More
