...
function ServiceCard({ s, i, inView }: { s: typeof SERVICES[0]; i: number; inView: boolean }) {
  ...
  return (
    <motion.div
      ...
      className="bg-white/[0.03] border border-white/10 rounded-2xl overflow-hidden hover:border-accent/40 hover:shadow-[0_0_28px_rgba(56,189,248,0.1)] transition-all duration-300"
    >
      <button
