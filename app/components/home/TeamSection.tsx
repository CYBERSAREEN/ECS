        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {TEAM.map((m, i) => (
            <motion.div
              ...
              className="group bg-white/[0.03] border border-white/10 rounded-2xl p-8 text-center hover:border-accent/40 hover:bg-white/[0.05] hover:shadow-[0_0_28px_rgba(56,189,248,0.1)] transition-all duration-300"
            >
