      ...
      <div className="relative max-w-4xl mx-auto px-4 sm:px-6 w-full py-16 text-center">
        ...
        >
          ...
          <div className="absolute rounded-full"
               style={{ width: 180, height: 180, background: "radial-gradient(circle, rgba(56,189,248,0.18) 0%, transparent 70%)" }} />
          {/* Logo */}
          <motion.div
            animate={{ y: [0, -10, 0] }}
          ...
          >
            <Image
              ...
              height={120}
              priority
              className="drop-shadow-[0_0_30px_rgba(56,189,248,0.35)] select-none"
            />
          </motion.div>
        </motion.div>
        ...
        >
          EXCELON CYBER
          <span className="block text-gradient drop-shadow-[0_0_20px_rgba(56,189,248,0.3)]">
            SOLUTIONS
          </span>
        </motion.h1>
        ...
        >
          <Link
            href="/services"
            className="group inline-flex items-center gap-2 bg-accent text-[#020617] font-bold px-7 py-3.5 rounded-xl hover:shadow-[0_0_28px_rgba(56,189,248,0.45)] transition-all duration-300"
          >
